...
pub async fn generated_space_call_on_chat_core(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    match request.methodName.as_str() {
        "afterChangeRoute" => Box::pin(generated_space_call_on_chat_core_afterChangeRoute(core, request)).await,
        "beforeChangeRoute" => Box::pin(generated_space_call_on_chat_core_beforeChangeRoute(core, request)).await,
        "cancelMessage" => Box::pin(generated_space_call_on_chat_core_cancelMessage(core, request)).await,
        "clearPendingQueueAutoDequeueSuppression" => Box::pin(generated_space_call_on_chat_core_clearPendingQueueAutoDequeueSuppression(core, request)).await,
        "deleteMessage" => Box::pin(generated_space_call_on_chat_core_deleteMessage(core, request)).await,
        "deleteMessages" => Box::pin(generated_space_call_on_chat_core_deleteMessages(core, request)).await,
        "deleteMessagesFrom" => Box::pin(generated_space_call_on_chat_core_deleteMessagesFrom(core, request)).await,
        "deletePendingQueueMessage" => Box::pin(generated_space_call_on_chat_core_deletePendingQueueMessage(core, request)).await,
        "enqueuePendingQueueMessage" => Box::pin(generated_space_call_on_chat_core_enqueuePendingQueueMessage(core, request)).await,
        "previewWorkspaceChangesForMessage" => Box::pin(generated_space_call_on_chat_core_previewWorkspaceChangesForMessage(core, request)).await,
        "regenerateSingleAiMessage" => Box::pin(generated_space_call_on_chat_core_regenerateSingleAiMessage(core, request)).await,
        "restorePendingQueueMessage" => Box::pin(generated_space_call_on_chat_core_restorePendingQueueMessage(core, request)).await,
        "resume" => Box::pin(generated_space_call_on_chat_core_resume(core, request)).await,
        "rewindAndResendMessage" => Box::pin(generated_space_call_on_chat_core_rewindAndResendMessage(core, request)).await,
        "rewindWorkspaceForMessage" => Box::pin(generated_space_call_on_chat_core_rewindWorkspaceForMessage(core, request)).await,
        "rollbackToMessage" => Box::pin(generated_space_call_on_chat_core_rollbackToMessage(core, request)).await,
        "sendUserMessage" => Box::pin(generated_space_call_on_chat_core_sendUserMessage(core, request)).await,
        "setPendingQueueExpanded" => Box::pin(generated_space_call_on_chat_core_setPendingQueueExpanded(core, request)).await,
        "takeNextPendingQueueMessageIfReady" => Box::pin(generated_space_call_on_chat_core_takeNextPendingQueueMessageIfReady(core, request)).await,
        "takePendingQueueMessage" => Box::pin(generated_space_call_on_chat_core_takePendingQueueMessage(core, request)).await,
        "updateMessage" => Box::pin(generated_space_call_on_chat_core_updateMessage(core, request)).await,
...
async fn generated_space_call_on_chat_core_afterChangeRoute(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_afterChangeRoute(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_beforeChangeRoute(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_beforeChangeRoute(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_cancelMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_cancelMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_clearPendingQueueAutoDequeueSuppression(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_clearPendingQueueAutoDequeueSuppression(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_deleteMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_deleteMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_deleteMessages(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_deleteMessages(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_deleteMessagesFrom(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_deleteMessagesFrom(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_deletePendingQueueMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_deletePendingQueueMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_enqueuePendingQueueMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_enqueuePendingQueueMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_previewWorkspaceChangesForMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_previewWorkspaceChangesForMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_regenerateSingleAiMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_regenerateSingleAiMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_restorePendingQueueMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_restorePendingQueueMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_resume(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_resume(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_rewindAndResendMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_rewindAndResendMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_rewindWorkspaceForMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_rewindWorkspaceForMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_rollbackToMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_rollbackToMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_sendUserMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_sendUserMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_setPendingQueueExpanded(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_setPendingQueueExpanded(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_takeNextPendingQueueMessageIfReady(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_takeNextPendingQueueMessageIfReady(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_takePendingQueueMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_takePendingQueueMessage(request).await
}

/// Dispatches one generated Space call method on the runtime's main ChatServiceCore.
async fn generated_space_call_on_chat_core_updateMessage(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreCallRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_call_updateMessage(request).await
}
...
pub async fn generated_space_watch_snapshot_on_chat_core(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: &operit_link::CoreWatchRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    match request.propertyName.as_str() {
        "chatMessagesFlow" => Box::pin(generated_space_watch_snapshot_on_chat_core_chatMessagesFlow(core, request)).await,
        "chatStateFlow" => Box::pin(generated_space_watch_snapshot_on_chat_core_chatStateFlow(core, request)).await,
        "routeProbeChatMessagesFlow" => Box::pin(generated_space_watch_snapshot_on_chat_core_routeProbeChatMessagesFlow(core, request)).await,
...
async fn generated_space_watch_snapshot_on_chat_core_chatMessagesFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: &operit_link::CoreWatchRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_snapshot_chatMessagesFlow(request).await
}

/// Reads one generated Space watch snapshot method on the runtime's main ChatServiceCore.
async fn generated_space_watch_snapshot_on_chat_core_chatStateFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: &operit_link::CoreWatchRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_snapshot_chatStateFlow(request).await
}

/// Reads one generated Space watch snapshot method on the runtime's main ChatServiceCore.
async fn generated_space_watch_snapshot_on_chat_core_routeProbeChatMessagesFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: &operit_link::CoreWatchRequest) -> Result<operit_link::CoreValue, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_snapshot_routeProbeChatMessagesFlow(request).await
}
...
pub async fn generated_space_watch_on_chat_core(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreWatchRequest, attachmentAdopter: std::sync::Arc<dyn Fn(Vec<operit_link::CoreStreamAttachment>) + Send + Sync>) -> Result<operit_link::CoreEventStream, operit_link::CoreLinkError> {
    match request.propertyName.as_str() {
        "chatMessagesFlow" => Box::pin(generated_space_watch_on_chat_core_chatMessagesFlow(core, request, attachmentAdopter)).await,
        "chatStateFlow" => Box::pin(generated_space_watch_on_chat_core_chatStateFlow(core, request, attachmentAdopter)).await,
        "routeProbeChatMessagesFlow" => Box::pin(generated_space_watch_on_chat_core_routeProbeChatMessagesFlow(core, request, attachmentAdopter)).await,
        _ => Err(operit_link::CoreLinkError::watchNotFound(&request.registryKey())),
    }
}

/// Opens one generated Space watch method on the runtime's main ChatServiceCore.
async fn generated_space_watch_on_chat_core_chatMessagesFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreWatchRequest, attachmentAdopter: std::sync::Arc<dyn Fn(Vec<operit_link::CoreStreamAttachment>) + Send + Sync>) -> Result<operit_link::CoreEventStream, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_chatMessagesFlow(request, attachmentAdopter).await
}

/// Opens one generated Space watch method on the runtime's main ChatServiceCore.
async fn generated_space_watch_on_chat_core_chatStateFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreWatchRequest, attachmentAdopter: std::sync::Arc<dyn Fn(Vec<operit_link::CoreStreamAttachment>) + Send + Sync>) -> Result<operit_link::CoreEventStream, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_chatStateFlow(request, attachmentAdopter).await
}

/// Opens one generated Space watch method on the runtime's main ChatServiceCore.
async fn generated_space_watch_on_chat_core_routeProbeChatMessagesFlow(core: &mut operit_runtime::services::ChatServiceCore::ChatServiceCore, request: operit_link::CoreWatchRequest, attachmentAdopter: std::sync::Arc<dyn Fn(Vec<operit_link::CoreStreamAttachment>) + Send + Sync>) -> Result<operit_link::CoreEventStream, operit_link::CoreLinkError> {
    core.__operit_core_route_watch_routeProbeChatMessagesFlow(request, attachmentAdopter).await
}
